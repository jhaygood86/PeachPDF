...
- **[Declarative Document-Building API](declarative-api.md)** — build a PDF directly from C# with `PdfGenerator.CreateDocument`, no HTML/CSS strings: pages, containers, text, images, rows/columns, tables, lists, and repeating headers/footers with page numbers.
