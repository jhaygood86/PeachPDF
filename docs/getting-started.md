...
- **[PeachDrawing.Text](peachdrawing-text.md)** — the font and text engine as its own dependency-free NuGet package: bidirectional text, script itemization, hyphenation and emoji presentation.
