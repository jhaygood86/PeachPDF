...
Two boundaries: the above holds for a forced break carried by the container's own child. A break declared further down — inside a wrapper inside the container — is lost entirely, producing neither a page break nor a column break.
