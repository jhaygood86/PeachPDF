...
| `background-repeat` | [background-repeat](https://developer.mozilla.org/en-US/docs/Web/CSS/background-repeat) | Full support; a single value applies to every `background-image` layer (not yet per-layer via comma list) |
