...
(`HtmlContainerInt.UseVariableInlineMeasure` — see "Per-page content bands" in `docs/architecture.md`).
...
because of `UseVariableInlineMeasure`'s per-page reflow, the container-query loop does not re-evaluate
