...
namespace PeachPDF.Html.Adapters
{
    ...
    internal abstract class RAdapter
    {
        ...
        /// </summary>
        public RFont? GetSystemFallbackFontForCodepoint(double size, RFontStyle style, System.Text.Rune codepoint, int? weight = null, int? stretch = null, double? obliqueSkewSinus = null, PeachDrawing.Text.Internal.Text.EmojiPresentation presentation = PeachDrawing.Text.Internal.Text.EmojiPresentation.NoPreference)
        {
        ...
        internal RFont? CreateSystemFallbackFontForCodepoint(double size, RFontStyle style, int weight, int stretch, double? obliqueSkewSinus, System.Text.Rune codepoint, PeachDrawing.Text.Internal.Text.EmojiPresentation presentation)
        {
        ...
        /// </summary>
        protected abstract RFont? CreateSystemFallbackFontForCodepointInt(double size, RFontStyle style, int weight, int stretch, double? obliqueSkewSinus, System.Text.Rune codepoint, PeachDrawing.Text.Internal.Text.EmojiPresentation presentation);
