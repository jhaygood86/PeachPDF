    ...
    internal static class CssUtils
    {
        ...
        private static readonly FrozenDictionary<string, Func<CssBox, string?>> _propertyGetters =
            new Dictionary<string, Func<CssBox, string?>>
            {
                ...
                ["box-decoration-break"] = b => b.BoxDecorationBreak,
                ...
                ["margin-block-start"] = b => b.MarginBlockStart,
                ["margin-block-end"] = b => b.MarginBlockEnd,
                ["margin-inline-start"] = b => b.MarginInlineStart,
                ["margin-inline-end"] = b => b.MarginInlineEnd,
                ["padding-block-start"] = b => b.PaddingBlockStart,
                ["padding-block-end"] = b => b.PaddingBlockEnd,
                ["padding-inline-start"] = b => b.PaddingInlineStart,
                ["padding-inline-end"] = b => b.PaddingInlineEnd,
                ["inset-block-start"] = b => b.InsetBlockStart,
                ["inset-block-end"] = b => b.InsetBlockEnd,
                ["inset-inline-start"] = b => b.InsetInlineStart,
                ["inset-inline-end"] = b => b.InsetInlineEnd,
                ["border-block-start-width"] = b => b.BorderBlockStartWidth,
                ["border-block-start-style"] = b => b.BorderBlockStartStyle,
                ["border-block-start-color"] = b => b.BorderBlockStartColor,
                ["border-block-end-width"] = b => b.BorderBlockEndWidth,
                ["border-block-end-style"] = b => b.BorderBlockEndStyle,
                ["border-block-end-color"] = b => b.BorderBlockEndColor,
                ["border-inline-start-width"] = b => b.BorderInlineStartWidth,
                ["border-inline-start-style"] = b => b.BorderInlineStartStyle,
                ["border-inline-start-color"] = b => b.BorderInlineStartColor,
                ["border-inline-end-width"] = b => b.BorderInlineEndWidth,
                ["border-inline-end-style"] = b => b.BorderInlineEndStyle,
                ["border-inline-end-color"] = b => b.BorderInlineEndColor,
                ...
                ["font-variant-caps"] = b => b.FontVariantCaps,
                ["font-variant-ligatures"] = b => b.FontVariantLigatures,
                ["font-variant-numeric"] = b => b.FontVariantNumeric,
                ["font-variant-east-asian"] = b => b.FontVariantEastAsian,
                ["font-feature-settings"] = b => b.FontFeatureSettings,
        ...
        [
            ...
            "bottom", "box-decoration-break", "box-sizing",
            "break-after", "break-before", "break-inside",
            "page-break-after", "page-break-before", "page-break-inside",
            "orphans", "widows", "hyphens",
            "clear", "color", "content",
            ...
            "font-family", "font-size", "font-stretch", "font-style", "font-variant-caps", "font-variant-ligatures",
            "font-variant-numeric", "font-variant-east-asian", "font-feature-settings", "font-weight", "font-palette",
            "height",
        ...
        private static readonly FrozenDictionary<string, Action<CssValueParser, CssBox, string>> _propertySetters =
            new Dictionary<string, Action<CssValueParser, CssBox, string>>
            {
                ...
                ["box-decoration-break"] = (_, b, v) => { if (v is CssConstants.Slice or CssConstants.Clone) b.BoxDecorationBreak = v; },
                ...
                // Logical margin/padding/inset/border longhands - cascaded into their own CssBox field
                // (matching their physical siblings' shape exactly, including margin/padding/inset's own
                // lack of value validation), then resolved to the correct physical edge by
                // CssBox.ResolveLogicalProperties once this box's own Direction/WritingMode are known.
                ["margin-block-start"] = (_, b, v) => b.MarginBlockStart = v,
                ["margin-block-end"] = (_, b, v) => b.MarginBlockEnd = v,
                ["margin-inline-start"] = (_, b, v) => b.MarginInlineStart = v,
                ["margin-inline-end"] = (_, b, v) => b.MarginInlineEnd = v,
                ["padding-block-start"] = (_, b, v) => b.PaddingBlockStart = v,
                ["padding-block-end"] = (_, b, v) => b.PaddingBlockEnd = v,
                ["padding-inline-start"] = (_, b, v) => b.PaddingInlineStart = v,
                ["padding-inline-end"] = (_, b, v) => b.PaddingInlineEnd = v,
                ["inset-block-start"] = (_, b, v) => b.InsetBlockStart = v,
                ["inset-block-end"] = (_, b, v) => b.InsetBlockEnd = v,
                ["inset-inline-start"] = (_, b, v) => b.InsetInlineStart = v,
                ["inset-inline-end"] = (_, b, v) => b.InsetInlineEnd = v,
                ["border-block-start-width"] = (_, b, v) => { if (IsValidLengthProperty(v)) b.BorderBlockStartWidth = v; },
                ["border-block-start-style"] = (_, b, v) => { if (IsValidBorderStyleProperty(v)) b.BorderBlockStartStyle = v; },
                ["border-block-start-color"] = (p, b, v) => { if (IsValidColorProperty(p, v)) b.BorderBlockStartColor = v; },
                ["border-block-end-width"] = (_, b, v) => { if (IsValidLengthProperty(v)) b.BorderBlockEndWidth = v; },
                ["border-block-end-style"] = (_, b, v) => { if (IsValidBorderStyleProperty(v)) b.BorderBlockEndStyle = v; },
                ["border-block-end-color"] = (p, b, v) => { if (IsValidColorProperty(p, v)) b.BorderBlockEndColor = v; },
                ["border-inline-start-width"] = (_, b, v) => { if (IsValidLengthProperty(v)) b.BorderInlineStartWidth = v; },
                ["border-inline-start-style"] = (_, b, v) => { if (IsValidBorderStyleProperty(v)) b.BorderInlineStartStyle = v; },
                ["border-inline-start-color"] = (p, b, v) => { if (IsValidColorProperty(p, v)) b.BorderInlineStartColor = v; },
                ["border-inline-end-width"] = (_, b, v) => { if (IsValidLengthProperty(v)) b.BorderInlineEndWidth = v; },
                ["border-inline-end-style"] = (_, b, v) => { if (IsValidBorderStyleProperty(v)) b.BorderInlineEndStyle = v; },
                ["border-inline-end-color"] = (p, b, v) => { if (IsValidColorProperty(p, v)) b.BorderInlineEndColor = v; },
                ...
                ["font-variant-caps"] = (_, b, v) => b.FontVariantCaps = v,
                ["font-variant-ligatures"] = (_, b, v) => b.FontVariantLigatures = v,
                ["font-variant-numeric"] = (_, b, v) => b.FontVariantNumeric = v,
                ["font-variant-east-asian"] = (_, b, v) => b.FontVariantEastAsian = v,
                ["font-feature-settings"] = (_, b, v) => b.FontFeatureSettings = v,
