...
namespace PeachPDF.CSS
{
    ...
    /// keyword, a single optional <c>font-variant-emoji</c> keyword, and a single optional
    /// <c>font-variant-alternates</c> clause set, combined (in any order)
            ...
            new IdentifierValueConverter<object>(Keywords.None, null).For(PropertyNames.FontVariantLigatures)
                .Or(
                    WithAny(
                        ...
                        FontVariantEmojiConverter.Option().For(PropertyNames.FontVariantEmoji),
