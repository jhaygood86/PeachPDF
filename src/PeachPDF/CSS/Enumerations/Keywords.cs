namespace PeachPDF.CSS
{
    internal static class Keywords
    {
        ...
        public static readonly string AllSmallCaps = "all-small-caps";
        public static readonly string PetiteCaps = "petite-caps";
        public static readonly string AllPetiteCaps = "all-petite-caps";
        public static readonly string Unicase = "unicase";
        public static readonly string TitlingCaps = "titling-caps";
        public static readonly string LiningNums = "lining-nums";
        public static readonly string OldstyleNums = "oldstyle-nums";
        public static readonly string ProportionalNums = "proportional-nums";
        public static readonly string TabularNums = "tabular-nums";
        public static readonly string DiagonalFractions = "diagonal-fractions";
        public static readonly string StackedFractions = "stacked-fractions";
        public static readonly string Ordinal = "ordinal";
        public static readonly string SlashedZero = "slashed-zero";
        public static readonly string Jis78Forms = "jis78-forms";
        public static readonly string Jis83Forms = "jis83-forms";
        public static readonly string Jis90Forms = "jis90-forms";
        public static readonly string Jis04Forms = "jis04-forms";
        public static readonly string Simplified = "simplified";
        public static readonly string Traditional = "traditional";
        public static readonly string ProportionalWidth = "proportional-width";
