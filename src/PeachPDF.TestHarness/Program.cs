...
// ── Image formats: JPG/PNG/GIF/WebP/AVIF, all decoded from the same source image ──────
// The same 96x96 gradient-plus-checkerboard-alpha source image, independently re-encoded into each
// format, so the grid demonstrates format parity - decoded via the current OS's native codec
// (WicImageCodec/AppleImageIoCodec/LinuxPlatformCodec/AndroidNdkImageDecoder) where available, falling
// back to StbImageSharp for JPG/PNG/GIF (WebP/AVIF have no STB fallback - see docs/getting-started.md).
var imageFormatsJpg = "data:image/jpeg;base64,";
var imageFormatsPng = "data:image/png;base64,";
var imageFormatsGif = "data:image/gif;base64,";
var imageFormatsWebp = "data:image/webp;base64,";
var imageFormatsAvif = "data:image/avif;base64,";

static string FormatCell(string label, string img) =>
    "<div class=\"cell\">" +
    $"<div class=\"frame\"><img src=\"{img}\" style=\"width:96px;height:96px;\"></div>" +
    $"<div class=\"lbl\">{label}</div></div>";

var imageFormatsHtml =
    "<html><head><style>" +
    "body { font-family: sans-serif; margin: 24px; color: #1a1a1a; }" +
    "h2 { font-size: 20px; margin: 0 0 4px; }" +
    ".note { color: #555; font-size: 12px; margin: 0 0 16px; }" +
    ".row { display: flex; flex-wrap: wrap; gap: 14px; }" +
    ".cell { font-size: 11px; color: #555; }" +
    ".frame { width: 96px; height: 96px; border: 1px solid #cbd5e1; border-radius: 6px; overflow: hidden; background: #f1f5f9; }" +
    ".lbl { margin-top: 6px; font-family: monospace; }" +
    "</style></head><body>" +
    "<h2>Image formats</h2>" +
    "<p class=\"note\">The same source image, independently re-encoded into each format and decoded here " +
    "through PeachPDF's image pipeline (an OS-native codec where available, StbImageSharp otherwise).</p>" +
    "<div class=\"row\">" +
    FormatCell("JPEG", imageFormatsJpg) +
    FormatCell("PNG", imageFormatsPng) +
    FormatCell("GIF", imageFormatsGif) +
    FormatCell("WebP", imageFormatsWebp) +
    FormatCell("AVIF", imageFormatsAvif) +
    "</div>" +
    "</body></html>";

await SaveShowcaseAsync("image_formats", "Images & Replaced Content", "Image formats",
    "JPG, PNG, GIF, WebP, and AVIF versions of the same source image, all decoded through PeachPDF's " +
    "native-codec-first image pipeline (WIC on Windows, Image I/O on macOS/iOS, libavif/libwebp on Linux, " +
    "NDK ImageDecoder on Android), falling back to StbImageSharp where no native codec is available.",
    imageFormatsHtml, pdfConfig);
