namespace PeachDrawing.Text.Internal.Text
{
    ...
    /// <see cref="PeachDrawing.Text.Internal.Text.Shaping.Use.UseCategoryClassifier"/> to pick a matra/modifier's
    ...
    /// <c>PeachDrawing.Text.Internal.Text.Shaping.Use.UseReorderer</c> moves before the syllable's base consonant).
