...
namespace PeachDrawing.Text.Internal.Text
{
    ...
    /// This is general text-processing logic built from <c>PeachDrawing.Text.Internal.Fonts.OpenType</c>'s table data,
    /// hence its own <c>PeachDrawing.Text.Internal.Text</c> namespace - see <see cref="HyphenationEngine"/> for the same
