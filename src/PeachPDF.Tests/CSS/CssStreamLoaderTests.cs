namespace PeachPDF.Tests.CSS
{
    ...
    public class CssStreamLoaderTests
    {
        ...
        public void Load_NoBom_DefaultsToUtf8()
        {
            ...
            var result = CssStreamLoader.Load(stream);

            Assert.Equal(Text, result.ToString());
        }

        [Fact]
        public void Load_Utf8Bom_IsStrippedAndDecodedCorrectly()
        {
        ...
        [Fact]
        public void Load_Utf16LeBom_IsStrippedAndDecodedCorrectly()
        {
        ...
        [Fact]
        public void Load_Utf16BeBom_IsStrippedAndDecodedCorrectly()
        {
        ...
        [Fact]
        public void Load_Utf32LeBom_IsStrippedAndDecodedCorrectly()
        {
        ...
        [Fact]
        public void Load_Utf32BeBom_IsStrippedAndDecodedCorrectly()
        {
        ...
        [Fact]
        public void Load_ShortStream_UnderFourBytes_DoesNotThrow()
        {
        ...
        [Fact]
        public void Load_LargeContent_SpanningMultiplePipeSegments_DecodesCorrectly()
        {
        ...
        [Fact]
        public void Load_MultiByteCharacter_NearBufferBoundary_DecodesCorrectly()
        {
        ...
        [Fact]
        public async System.Threading.Tasks.Task LoadAsync_MatchesSyncLoad()
        {
            using var stream = new MemoryStream(new UTF8Encoding(false).GetBytes(Text));

            var result = await CssStreamLoader.LoadAsync(stream, null, System.Threading.CancellationToken.None);

            Assert.Equal(Text, result.ToString());
        }

        [Fact]
        public void Load_ExplicitEncoding_UsedWhenNoBomPresent()
        {
            var encoding = new UTF8Encoding(false);
            using var stream = new MemoryStream(encoding.GetBytes(Text));

            var result = CssStreamLoader.Load(stream, encoding);
