...
namespace PeachPDF.Tests.TestSupport
{
    ...
    /// machine running them. These bundled, OFL-1.1-licensed Source Sans 3 assets guarantee
    /// at least one TrueType (glyf) and one OpenType (CFF) font are always available,
    /// regardless of platform or CI environment.
    /// </summary>
    internal static class BundledFonts
    {
        ...
        internal static string Otf => Path.Combine(AppContext.BaseDirectory, "SourceSans3-Regular.otf");
