...
<body>
    ...
    <div class='box' style='z-index: 2; top: -50px; left: 50px; background: blue;'>Front</div>
        ...
        private sealed class DrawCountingGraphics : RGraphics
        {
            ...
            public override void DrawString(string str, RFont font, RColor color, RPoint point, RSize size, double letterSpacing = 0, RFontPalette? fontPalette = null, LigatureFeatures ligatureFeatures = LigatureFeatures.Default) => DrawOperations++;
