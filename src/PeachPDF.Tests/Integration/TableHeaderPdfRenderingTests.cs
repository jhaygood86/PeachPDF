    ...
    <td>${i * 10}.00</td>
     ...
     $"PDF should have at least 2 pages");
        ...
        sealed class DrawStringRecordingGraphics : RGraphics
        {
            ...
            public override void DrawString(string str, RFont font, RColor color, RPoint point, RSize size, double letterSpacing = 0, RFontPalette? fontPalette = null, LigatureFeatures ligatureFeatures = LigatureFeatures.Default) => DrawnStrings.Add(str);
