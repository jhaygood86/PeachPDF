...
namespace PeachPDF.Tests.Integration
{
    ...
    public class StructuralCloneBreakValueBehaviourTests
    {
        ...
        public async Task SplitFragmentsCarryBreakAfter_ButAnAnonymousWrapperSeparatesThemFromTheirSibling()
        {
            ...
            Assert.All(spans, s => Assert.Equal(Keywords.Avoid, s.BreakAfter.ToString()));
            ...
            Assert.Equal(Keywords.Auto, predecessor.BreakAfter.ToString());
            Assert.Empty(DomUtils.GetPrecedingKeepWithNextRun(kept!, PeachPDF.Html.Core.Fragmentation.FragmentationContext.Page));
        }
